...
def make_prompt(user_input: str) -> str:
    return (
        ...
        "When answering, provide a brief summary (2-3 sentences) to start and also list sources (URLs or titles) you used. "
        "If the user asks questions straying from the topics of women's health, politely move them back on subject. The focus is on accessible education on women's health. "
        #""
